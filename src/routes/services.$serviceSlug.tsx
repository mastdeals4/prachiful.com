...
export const Route = createFileRoute("/services/$serviceSlug")({
  head: ({ params }) => {
    ...
    const url = `https://prachifulfagar.com/services/${params.serviceSlug}`;
    const faqs = serviceFaqs[params.serviceSlug];
    const ldGraph: Array<Record<string, unknown>> = [
      {
        ...
        description,
        url,
        provider: { "@id": "https://prachifulfagar.com/#organization" },
        areaServed: ["India", "Worldwide"],
      },
      {
        "@type": "BreadcrumbList",
        itemListElement: [
          { "@type": "ListItem", position: 1, name: "Home", item: "https://prachifulfagar.com/" },
          { "@type": "ListItem", position: 2, name: "Services", item: "https://prachifulfagar.com/services" },
          { "@type": "ListItem", position: 3, name: service?.name ?? "Service", item: url },
        ],
      },
    ];
