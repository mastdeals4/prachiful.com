...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;1,300;1,400&family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500&display=swap" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            {
              "@type": "Organization",
              "@id": "https://prachifulfagar.com/#organization",
              name: "Prachi Fulfagar",
              url: "https://prachifulfagar.com/",
              logo: "https://prachifulfagar.com/favicons/apple-touch-icon.png",
              sameAs: [
            ...
            {
              "@type": "WebSite",
              "@id": "https://prachifulfagar.com/#website",
              url: "https://prachifulfagar.com/",
              name: "Prachi Fulfagar",
              publisher: { "@id": "https://prachifulfagar.com/#organization" },
              inLanguage: "en-IN",
            },
          ],
        }),
